...
/// Teacher-specific Report Cards page
/// Filters report cards by teacher assignment only
class TeacherReportCardsPage extends StatefulWidget {
  const TeacherReportCardsPage({super.key});

  @override
  State<TeacherReportCardsPage> createState() => _TeacherReportCardsPageState();
}

class _TeacherReportCardsPageState extends State<TeacherReportCardsPage> {
  @override
  void initState() {
    super.initState();
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('${exam.className} - Generate report cards'),
