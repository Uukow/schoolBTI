 ...
 * View Invoice Page
 * 
 * Display detailed invoice information with payment history
 * 
...
if (empty($invoiceId)) {
    ...
    redirect(APP_URL . 'modules/fees/invoices.php');
}
...
if (!hasRole(['Super Admin'])) {
    $sql .= " AND s.branch_id = ?";
    $stmt = executeQuery($sql, 'ii', [$invoiceId, $currentUser['branch_id']]);
} else {
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?php echo APP_URL; ?>modules/fees/invoices.php" class="btn btn-secondary">
